...
def retrieve_relevant_chunks(job_id: str, query: str, limit: int = 3) -> str:
...
def generate_single_period(metadata, job_id: str, period) -> PeriodContent:
    ...
    retrieved_context = retrieve_relevant_chunks(job_id, search_query)
